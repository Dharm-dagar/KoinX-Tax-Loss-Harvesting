// Mock API layer — simulates network delay with Promise + setTimeout
// In production, replace these with real fetch/axios calls
...
/**
 * Fetches capital gains data.
 * @returns {Promise<Object>}
 */
export async function fetchCapitalGains() {
  await delay(DELAY_MS - 200);
